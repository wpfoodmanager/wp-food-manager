...
<div class="single_food_listing">
    <div class="wpfm-main wpfm-single-food-page">
        <?php if (get_option('food_manager_hide_expired_content', 1) && 'expired' === $post->post_status) : ?>
            <div class="food-manager-info wpfm-alert wpfm-alert-danger">
                <?php esc_html_e('This listing has been expired.', 'wp-food-manager'); ?>
            </div>
        <?php else :
            /**
                ...
                <div class="wpfm-single-food-header-top">
                    <div class="wpfm-row">
                        <div class="wpfm-col-xs-12 wpfm-col-sm-12 wpfm-col-md-12 wpfm-single-food-images">
                            <?php
                            $food_banners = get_wpfm_food_banner();
                            ...
                            <?php else : ?>
                                <div class="wpfm-food-single-image-wrapper">
                                    <div class="wpfm-food-single-image"><?php wpfm_display_food_banner(); ?></div>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="wpfm-row">
                        <div class="wpfm-col-xs-12 wpfm-col-sm-7 wpfm-col-md-8 wpfm-single-food-left-content">
                                ...
                                <div class="wpfm-food-details">
                                    <div class="food-details-row">
                                        <div class="food-menu-label">
                                            <?php echo esc_html( apply_filters( 'wpfm_food_label', get_post_meta( $post->ID, '_food_label', true ) ) ); ?>
                                        </div>
                                        <?php $view_count = wpfm_get_food_views_count($post);
                                        if ($view_count) : ?>
                                    ...
                                    <div class="wpfm-food-title">
                                        ...
                                        <?php wpfm_display_food_veg_nonveg_icon_tag(); ?>
                                    </div>
                                    <div class="wpfm-food-price">
                                        <?php wpfm_display_food_price_tag(); ?>
                                    </div>
                                    <?php if (wpfm_get_stock_status() == 'food_outofstock') : ?>
                                        <div class="food-stock-status">
                                            <?php wpfm_display_stock_status(); ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="wpfm-single-food-body-content">
                                ...
                                echo wp_kses_post( apply_filters( 'wpfm_the_content', $post->post_content ) );
                                do_action('single_food_overview_end');
                                $ingredients = wpfm_get_food_ingredients();
                                $display_ingredients = is_wpfm_terms_exist($ingredients, 'food_manager_ingredient');
                                if ($display_ingredients && wpfm_get_food_ingredients() && get_post_meta($post->ID, '_enable_food_ingre', true)) : ?>
                                    <div class="clearfix">&nbsp;</div>
                                    <div class="wpfm-food-ingredients">
                                        <h3 class="wpfm-heading-text">
                                            <?php esc_html_e('Food Ingredients', 'wp-food-manager'); ?>
                                        </h3>
                                        <?php wpfm_display_food_ingredients(); ?>
                                    </div>
                                <?php endif;
                                $nutritions = wpfm_get_food_nutritions();
                                $display_nutritions = is_wpfm_terms_exist($nutritions, 'food_manager_nutrition');
                                if ($display_nutritions && wpfm_get_food_nutritions() && get_post_meta($post->ID, '_enable_food_nutri', true)) : ?>
                                    <div class="clearfix">&nbsp;</div>
                                    <div class="wpfm-food-nutritions">
                                        <h3 class="wpfm-heading-text">
                                            <?php esc_html_e('Food Nutritions', 'wp-food-manager'); ?>
                                        </h3>
                                        <?php wpfm_display_food_nutritions(); ?>
                                    </div>
                                <?php endif; ?>
                                ...
                                <form class="wpfm-toppings wpfm-mt-4" id="wpfm_single_food_topping_form" method="post" action="" data-product-attribute='<?php echo esc_attr( apply_filters( 'wpfm_food_toppings_form_variation', '',  $food->ID ) ); ?>'>
                                    ...
                                    if (!empty($repeated_count)) {
                                        if (!empty($ext_options) && wpfm_check_empty_toppings($ext_options)) { ?>
                                            ...
                                            <h3 class='wpfm-heading-text'>
                                                <?php _e('Extra Toppings', 'wp-food-manager');?>
                                            </h3>
                                            <?php foreach ($ext_options as $key => $ext_option) {
                                                if (!empty($ext_option['_topping_name']) && !empty($ext_option['_topping_options'])) {
                                                    ...
                                                    <div class='wpfm-topping-list-item" <?php esc_attr_e($more_class);?>'>
                                                        <div class='wpfm-topping-item-header wpfm-d-flex wpfm-align-items-start'>
                                                            ...
                                                            <div class="wpfm-topping-item-header-text">
                                                                ...
                                                                <?php if( isset($ext_option['_topping_description']) && !empty($ext_option['_topping_description'])) { ?>
                                                                    <div class="wpfm-topping-item-description">
                                                                        <?php echo wp_kses_post($ext_option['_topping_description']);?>
                                                                    </div>
                                                                <?php }
                                                    
                                                                do_action('wpfm_singular_option_input_before');
    
                                                                $topping_html = '<ul class="wpfm-topping-options">';
                                                                    if (isset($ext_option['_topping_options']) && !empty($ext_option['_topping_options'])) {
                                                                        foreach ($ext_option['_topping_options'] as $ext_option_key => $ext_option_value) {
                                                                            ...
                                                                            $option_price_sep = '';
                                                                            if ($ext_option_formatted_option_price != '') {
                                                                                $option_price_sep = ' - ';
                                                                            }
                                                                ...
                                                                echo wp_kses( apply_filters( 'wpfm_toppings_list_htm', $topping_html, array(
                                                    ...
                                                    if (!empty($additional_fields_extra_topping)) {?>
                                                        <div class='wpfm-additional-main-row wpfm-row' style='display: none;'>
                                                            <?php $flag = 0;
                                                        ...
                                                        <?php if ($flag) { ?>
                                                            <span class="wpfm-view-more">
                                                                <?php echo esc_html__('View more +', 'wp-food-manager');?>
                                                            </span>
                                                        <?php }
                                                    } ?>
                                                    </div>
                        ...
                        do_action( 'food_manager_addons_html' ); // Call the action
                        $output = ob_get_clean(); // Get the buffered content and clean the buffer
                        echo wp_kses_post( $output ); // Escape the output for safe HTML
                        ?>
                    </div>
                    <!-- Additional Info Block Start -->
                    <?php $show_additional_details = apply_filters('food_manager_show_additional_details', true);
                        ...
                        if (!empty($additional_fields)) : ?>
                            <div class="wpfm-additional-info-block-wrapper">
                                <div class="wpfm-additional-info-block">
                                    <h3 class="wpfm-heading-text"><?php esc_html_e('Additional Details', 'wp-food-manager'); ?></h3>
                                </div>
                                                        ...
                                                        <div class="wpfm-col-12 wpfm-additional-info-block-group">
                                                            ...
                                                            <?php foreach ($field_value as $child_index => $child_value) :
                                                                foreach ($field['fields'] as $child_field_name => $child_field) :
                                                                    if (!empty($child_value[$child_field_name])) : ?>
                                                                        <div class="wpfm-col-md-6 wpfm-col-sm-12 wpfm-additional-info-block-details-content-left">
                                                                            <div class="wpfm-additional-info-block-details-content-items">
                                                                                <?php
                                                                                $child_options = [];
                                                                                foreach ($child_value[$child_field_name] as $key => $value) {
                                                                                    $child_options[] = $child_field['options'][$value];
                                                                                } ?>
                                                                                <p class="wpfm-additional-info-block-title">
                                                                                    <?php // translators: %s: The label of the child field ?>
                                                                                    <strong>
                                                                                        <?php printf( esc_html__( '%s', 'wp-food-manager' ), esc_html( $child_field['label'] ) ); ?> -
                                                                                    </strong>
                                                                                    <?php 
                                                                                    // translators: %s: A comma-separated list of values
                                                                                    printf( esc_html__( '%s', 'wp-food-manager' ), esc_html( implode( ', ', $child_options ) ) ); ?>
                                                                                </p>
                                                                    ...
                                                                    <?php elseif ($child_field['type'] == 'select') : ?>
                                                                        <div class="wpfm-col-md-6 wpfm-col-sm-12 wpfm-additional-info-block-details-content-left">
                                                                            <div class="wpfm-additional-info-block-details-content-items">
                                                                                ...
                                                                                <strong><?php printf( esc_html__( '%s', 'wp-food-manager' ), esc_html( $child_field['label'] ) ); ?> - </strong>
                                                                                <?php // Translators: %s is replaced with the child field value ?> 
                                                                                <?php printf( esc_html__( '%s', 'wp-food-manager' ), esc_html( $child_value[$child_field_name] ) ); ?></p>
                                                                            </div>
                                                                        </div>
                                                                        <?php if ($child_field['type'] == 'textarea' || $child_field['type'] == 'wp-editor') : ?>
                                                                            <div class="wpfm-col-12 wpfm-additional-info-block-textarea">
                                                                                <div class="wpfm-additional-info-block-details-content-items">
                                                                                    <p class="wpfm-additional-info-block-title">
                                                                                    <?php // Translators: %s represents the field label ?>
                                                                                    <strong><?php printf( esc_html__( '%s', 'wp-food-manager' ), esc_html( $child_field['label'] ) ); ?></strong></p>
                                                                        ...
                                                                        <?php elseif ($child_field['type'] == 'multiselect') : ?>
                                                                            <div class="wpfm-col-md-6 wpfm-col-sm-12 wpfm-additional-info-block-details-content-left">
                                                                                <div class="wpfm-additional-info-block-details-content-items">
                                                                                    ...
                                                                                    <strong><?php printf( esc_html__( '%s', 'wp-food-manager' ), esc_html( $child_field['label'] ) ); ?> -</strong>
                                                                                    <?php // Translators: %s is replaced with the child field value ?> 
                                                                                    <?php printf( esc_html__( '%s', 'wp-food-manager' ), esc_html( implode( ', ', $child_options ) ) ); ?></p>
                                                                                </div>
                                                                            </div>
                                                                        <?php elseif ($child_field['type'] == 'select') : ?>
                                                                            <div class="wpfm-col-md-6 wpfm-col-sm-12 wpfm-additional-info-block-details-content-left">
                                                                        ...
                                                                        <?php elseif ($child_field['type'] == 'date') : ?>
                                                                            <div class="wpfm-col-md-6 wpfm-col-sm-12 wpfm-additional-info-block-details-content-left">
                                                                                <div class="wpfm-additional-info-block-details-content-items">
                                                                                    ...
                                                                                    <strong><?php printf( esc_html__( '%s', 'wp-food-manager' ), esc_html( $child_field['label'] ) ); ?> - </strong> 
                                                                                    <?php // Translators: %s is replaced with the child field value ?> 
                                                                                    <?php echo esc_html( date_i18n( $date_format, strtotime( $child_value[$child_field_name] ) ) ); ?></p>
                                                                                    </div>
                                                                                </div>
                                                                        <?php elseif ($child_field['type'] == 'time') : ?>
                                                                            <div class="wpfm-col-md-6 wpfm-col-sm-12 wpfm-additional-info-block-details-content-left">
                                                                                <div class="wpfm-additional-info-block-details-content-items">
                                                                                    ...
                                                                                    <strong><?php printf( esc_html__( '%s', 'wp-food-manager' ), esc_html( $child_field['label'] ) ); ?> - </strong> 
                                                                                    <?php // Translators: %s is replaced with the child field value ?> 
                                                                                    <?php echo esc_html( date( $time_format, strtotime( $child_value[$child_field_name] ) ) ); ?></p>
                                                                                    </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="wpfm-additional-info-block-details-content-items wpfm-additional-file-slider">
                                                                                    <?php if (is_array($child_value[$child_field_name])) : ?>
                                                                                        <?php foreach ($child_value[$child_field_name] as $file) : ?>
                                                                                            ...
                                                                                            <?php else : ?>
                                                                                                <div class="wpfm-icon"><a target="_blank" class="wpfm-icon-download3" href="<?php echo esc_attr($file); ?>"> <?php esc_html_e('Download', 'wp-food-manager'); ?></a></div>
                                                                                            <?php endif; ?>
                                                                                        <?php endforeach; ?>
                                                                                    <?php else : ?>
                                                                                        ...
                                                                                        <?php else : ?>
                                                                                            <div class="wpfm-icon"><a target="_blank" class="wpfm-icon-download3" href="<?php echo esc_attr($child_value[$child_field_name]); ?>"> <?php esc_html_e('Download', 'wp-food-manager'); ?></a></div>
                                                                                        <?php endif; ?>
                                                                                    <?php endif; ?>
                                                                                </div>
                                                                            </div>
                                                                        <?php elseif ($child_field['type'] == 'url') : ?>
                                                                            <div class="wpfm-col-12 wpfm-additional-info-block-textarea">
                                                                                <div class="wpfm-additional-info-block-details-content-items">
                                                                                    ...
                                                                                    <?php // Translators: %s represents the field label ?>   
                                                                                    <?php printf( esc_html__( '%s', 'wp-food-manager' ), esc_html( $child_field['label'] ) ); ?></a></p>
                                                                                </div>
                                                                            </div>
                                                                        <?php else : ?>
                                                                            <?php if (is_array($child_value[$child_field_name])) : ?>
                                                ...
                                                ?>
                                                    <div class="wpfm-col-12 wpfm-additional-info-block-textarea">
                                                        <div class="wpfm-additional-info-block-details-content-items">
                                                            <p class="wpfm-additional-info-block-title">
                                                                <?php  // Translators: %s represents the field label ?>
                                                                <strong><?php printf( esc_html__( '%s', 'wp-food-manager' ), esc_html( $field['label'] ) ); ?></strong></p>
                                                            <p class="wpfm-additional-info-block-textarea-text">
                                                                <?php  // Translators: %s represents the field value ?>
                                                                <?php printf( esc_html__( '%s', 'wp-food-manager' ), esc_html( $field_value ) ); ?></p>
                                                        </div>
                                                    </div>
                                                <?php elseif ($field['type'] == 'multiselect') : ?>
                                                    <div class="wpfm-col-md-6 wpfm-col-sm-12 wpfm-additional-info-block-details-content-left">
                                                        <div class="wpfm-additional-info-block-details-content-items">
                                                            ...
                                                            if (isset($field_value) && !empty($field_value) && is_array($field_value)) {
                                                                foreach ($field_value as $key => $value) {
                                                                    if (isset($field['options'][$value])) {
                                                                        $child_options[] = $field['options'][$value];
                                                                    }
                                                                }
                                                            }
                                                            ?>
                                                            <p class="wpfm-additional-info-block-title">
                                                                <?php // Translators: %s represents the field label ?>
                                                                <strong><?php printf( esc_html__( '%s', 'wp-food-manager' ), esc_html( $field['label'] ) ); ?> -</strong>
                                                                <?php // Translators: %s is replaced with the comma-separated values of the array ?>
                                                                <?php printf( esc_html__( '%s', 'wp-food-manager' ), esc_html( implode( ', ', array_map( 'esc_html', $child_options ) ) ) ); ?></p>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="wpfm-additional-info-block-details-content-items">
                                                            <p class="wpfm-additional-info-block-title">
                                                                ...
                                                                if (isset($field['options'][$field_value]))
                                                                    ...
                                                                    printf( esc_html__( '%s', 'wp-food-manager' ), esc_html( $field['options'][$field_value] ) ); 
                                                                else
                                                                    // Translators: %s represents the field value
                                                                    printf(esc_html__('%s', 'wp-food-manager'),  esc_html($field_value));
                                                                ?></p>
                                                        </div>
                                                    </div>
                                                <?php elseif (isset($field['type']) && $field['type'] == 'date') :
                                                    ...
                                                    <div class="wpfm-col-md-6 wpfm-col-sm-12 wpfm-additional-info-block-details-content-left">
                                                        <div class="wpfm-additional-info-block-details-content-items">
                                                            <p class="wpfm-additional-info-block-title">
                                                            <?php // Translators: %s represents the field label ?>
                                                            <strong><?php printf( esc_html__('%s', 'wp-food-manager'), esc_html($field['label'])); ?> - </strong> <?php echo esc_html( date_i18n($date_format, strtotime($field_value)) ); ?></p>
                                                        </div>
                                                    </div>
                                                <?php elseif (isset($field['type']) && $field['type'] == 'time') : ?>
                                                    <div class="wpfm-col-md-6 wpfm-col-sm-12 wpfm-additional-info-block-details-content-left">
                                                        <div class="wpfm-additional-info-block-details-content-items">
                                                            <p class="wpfm-additional-info-block-title">
                                                                <?php // Translators: %s represents the field label ?>
                                                                <strong><?php printf(esc_html__('%s', 'wp-food-manager'), esc_html($field['label'])); ?> - </strong> <?php echo esc_html(date($time_format, strtotime($field_value))); ?></p>
                                                        </div>
                                                    </div>
                                                                            ...
                                                                            <?php else : ?>
                                                                                <div>
                                                                                    <div class="wpfm-icon">
                                                                                        ...
                                                                                        <a target="_blank" href="<?php echo esc_attr($file); ?>"><i class='wpfm-icon-download3' style='margin-right: 3px;'></i> <?php esc_html_e('Download', 'wp-food-manager'); ?></a>
                                                                                    </div>
                                                                                </div>
                                                                        <?php endif;
                                                                        }
                                                            ...
                                                            <p class="wpfm-additional-info-block-textarea-text">
                                                                <?php if (isset($field_value) && !empty($field_value)) { ?>
                                                                    <a target="_blank" href="<?php echo esc_url($field_value); ?>">
                                                                        <?php // Translators: %s represents the field label ?>
                                                                        <?php printf(esc_html__('%s', 'wp-food-manager'),  esc_html($field['label'])); ?></a>
                                                                    <?php } else {
                                                        ...
                                                        <div class="wpfm-additional-info-block-details-content-items">
                                                            <p class="wpfm-additional-info-block-textarea-text">
                                                                ...
                                                                if (is_array($field_value)) {
                                                                    $field_options = [];
                                                                    foreach ($field_value as $key => $value) {
                                                                        $field_options[] = $field['options'][$value];
                                                                    }
                                                                    // Translators: %s is replaced with a list of values from the array
                                                                    printf( esc_html__('%s', 'wp-food-manager'), esc_html( implode(', ', $field_options) ) ); 
                                                                } else {
                                                                    if ($field_value == 1) {
                        ...
                        <div class="wpfm-col-xs-12 wpfm-col-sm-5 wpfm-col-md-4 wpfm-single-food-right-content">
                            <div class="wpfm-single-food-body-sidebar">
                                ...
                                <div class="wpfm-single-food-sidebar-info">
                                    ...
                                    <?php if (get_option('food_manager_enable_categories') && wpfm_get_food_category()) : ?>
                                        <h3 class="wpfm-heading-text"><?php esc_html_e('Food Category', 'wp-food-manager'); ?></h3>
                                        <div class="wpfm-food-category"><?php wpfm_display_food_category(); ?></div>
                                    <?php endif; ?>
                                    <?php if (get_option('food_manager_enable_food_types') && wpfm_get_food_type()) : ?>
                                        <div class="clearfix">&nbsp;</div>
                                        <h3 class="wpfm-heading-text"><?php esc_html_e('Food Types', 'wp-food-manager'); ?></h3>
                                        <div class="wpfm-food-type"><?php wpfm_display_food_type(); ?></div>
                                    <?php endif; ?>
                                    <?php if (get_option('food_manager_enable_food_tags') && wpfm_get_food_tag()) : ?>
                                        <div class="clearfix">&nbsp;</div>
                                        <h3 class="wpfm-heading-text"><?php esc_html_e('Food Tags', 'wp-food-manager'); ?></h3>
                                        <div class="wpfm-food-tag"><?php wpfm_display_food_tag(); ?></div>
                                    <?php endif; ?>
                                ...
                                if ($is_friend_share) : ?>
                                    <div class="wpfm-share-this-food">
                                        <h3 class="wpfm-heading-text"><?php esc_html_e('Share With Friends', 'wp-food-manager'); ?></h3>
                                        <div class="wpfm-food-share-lists">
                                            ...
                                            <div class="wpfm-social-icon wpfm-facebook">
                                                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php wpfm_display_food_permalink(); ?>" title="Share this page on Facebook">Facebook</a>
                                            </div>
                                            <div class="wpfm-social-icon wpfm-twitter">
                                                <a href="https://twitter.com/share?text=twitter&url=<?php wpfm_display_food_permalink(); ?>" title="Share this page on Twitter">Twitter</a>
                                            </div>
                                            <div class="wpfm-social-icon wpfm-linkedin">
                                                <a href="https://www.linkedin.com/sharing/share-offsite/?&url=<?php wpfm_display_food_permalink(); ?>" title="Share this page on Linkedin">Linkedin</a>
                                            </div>
                                            <div class="wpfm-social-icon wpfm-xing">
                                                <a href="https://www.xing.com/spi/shares/new?url=<?php wpfm_display_food_permalink(); ?>" title="Share this page on Xing">Xing</a>
                                            </div>
                                            <div class="wpfm-social-icon wpfm-pinterest">
                                                <a href="https://pinterest.com/pin/create/button/?url=<?php wpfm_display_food_permalink(); ?>" title="Share this page on Pinterest">Pinterest</a>
                                            </div>
