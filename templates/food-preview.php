...
<form method="post" id="food_preview" action="<?php echo esc_url( $form->get_action() ); ?>">
	<div class="food_listing_preview_title">
		...
		<input type="submit" name="continue" id="food_preview_submit_button" class="button food-manager-button-submit-listing" value="<?php echo esc_attr( apply_filters( 'submit_event_step_preview_submit_text', __( 'Submit Listing →', 'wp-food-manager' ) ) ); ?>" />		
