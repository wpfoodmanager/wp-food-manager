        ...
        <div class="wpfm-row">
            <div class="wpfm-col wpfm-col-12 wpfm-col-sm-6 wpfm-col-md-6 wpfm-col-lg-8">
                <div class="wpfm-food-listing-header-title">
                    <h2 class="wpfm-heading-text"><?php _e('Foods', 'wp-food-manager'); ?></h2>
                </div>
            </div>
            <div class="wpfm-col wpfm-col-12 wpfm-col-sm-6 wpfm-col-md-6 wpfm-col-lg-4">
                <div class="wpfm-food-layout-action-wrapper">
                    <div class="wpfm-food-layout-action">
                        ...
                        <div class="wpfm-food-layout-icon wpfm-food-box-layout" title="<?php _e('foods Box View', 'wp-food-manager'); ?>" id="wpfm-food-box-layout"><i class="wpfm-icon-stop2"></i></div>
                        <div class="wpfm-food-layout-icon wpfm-food-list-layout wpfm-active-layout" title="<?php _e('foods List View', 'wp-food-manager'); ?>" id="wpfm-food-list-layout"><i class="wpfm-icon-menu"></i></div>
