    ...
    <div class="wpfm-food-box-col wpfm-col wpfm-col-12 wpfm-col-md-6 wpfm-col-lg-<?php echo esc_attr(apply_filters('food_manager_food_wpfm_column', '4')); ?>">
        ...
        <div class="wpfm-food-layout-wrapper">
            <div <?php food_manager_class(); ?>>
                <a href="<?php wpfm_display_food_permalink(); ?>" class="wpfm-food-action-url food-style-color <?php echo esc_attr($food_type); ?>">
                    ...
                    <div class="wpfm-food-infomation">
                        <div class="wpfm-food-details">
                            <div class="wpfm-food-title">
                                <h3 class="wpfm-heading-text"><?php echo esc_html(get_the_title()); ?> <?php wpfm_display_food_veg_nonveg_icon_tag(); ?></h3>
                            </div>
                            <?php do_action('food_list_overview_after', get_the_ID()); ?>
                            <div class="wpfm-food-price"><?php wpfm_display_food_price_tag(); ?></div>
                        </div>
                    </div>
                </a>
            </div>
    ...
    <div class="wpfm-food-box-col wpfm-col wpfm-col-12 wpfm-col-md-6 wpfm-col-lg-<?php echo esc_attr(apply_filters('food_manager_food_wpfm_column', '4')); ?>">
        ...
        <div class="wpfm-food-layout-wrapper">
            <div <?php food_manager_class(''); ?>>
                ...
                <div class="wpfm-food-infomation">
                    <div class="wpfm-food-details">
                        <a href="<?php wpfm_display_food_permalink(); ?>"
                        ...
                        <div class="wpfm-food-category">
                            <?php wpfm_display_food_category(); ?>
                        </div>
