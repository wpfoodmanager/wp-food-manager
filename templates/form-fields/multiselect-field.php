...
?>
<select multiple="multiple" name="<?php echo esc_attr(isset($field['name']) ? $field['name'] : $key); ?>[]" id="<?php echo esc_attr($key); ?>" class="food-manager-multiselect" data-no_results_text="<?php esc_html_e('No results match', 'wp-food-manager'); ?>" attribute="<?php echo esc_attr(isset($field['attribute']) ? $field['attribute'] : ''); ?>" data-multiple_text="<?php esc_html_e('Select Some Options', 'wp-food-manager'); ?>">
