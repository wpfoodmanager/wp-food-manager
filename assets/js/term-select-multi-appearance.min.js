var WPFMMultiAppearanceselect = function () {
    return {
        init: function () {
            WPFMCommon.logInfo("WPFMMultiAppearanceselect.init...");
...
WPFMMultiAppearanceselect = WPFMMultiAppearanceselect();
jQuery(document).ready(function ($) {
    WPFMMultiAppearanceselect.init();
});