<?php if (empty($menu_options) || $menu_options == 'static_menu') {
...
<div class="wpfm-admin-food-menu-container wpfm-flex-col wpfm-admin-postbox-meta-data static_menu <?php echo $first_div_hide_block; ?>">
    <div class="wpfm-admin-postbox-meta-data">
        <div class="wpfm-admin-menu-selection wpfm-admin-postbox-form-field">
            <?php 
            $selected_ids = get_post_meta($food_menu_id, '_food_cats_ids', true);
    ...
    <div class="wpfm-admin-food-menu-items">
        ...
        <?php if ($item_ids && is_array($item_ids)) { ?>
            <span class="no-menu-item-handle" style="display: none;">
                <?php _e('Please select the food category or food types to add food items to the menu.', 'wp-food-manager' ); ?>
            </span>
        <?php } else { ?>
            <span class="no-menu-item-handle">
                <?php _e('Please select the food category or food types to add food items to the menu.', 'wp-food-manager' ); ?>
            </span>
        <?php } ?>
        ...
        <div class="success_message">
            <span class="wpfm-success-message" style="display: none;">
                <?php _e('Foods added to the menu successfully!', 'wp-food-manager' ); ?>
            </span>
        </div>
    </div>
</div>
<div class="wpfm-admin-food-menu-container wpfm-flex-col wpfm-admin-postbox-meta-data dynamic_menu <?php echo $second_div_hide_block; ?>">
    <div class="wpfm-admin-postbox-meta-data">
        <table class="wpem-backend-custom-table wpem-backend-food-menu-table">
            <thead>
                <tr>
                    <th><?php _e('Days', 'wp-food-manager'); ?></th>
                    <th><?php _e('Select Food', 'wp-food-manager'); ?></th>
                </tr>
            </thead>
            <tbody>
            <?php
                        ...
                        <td>
                            <div class="wpfm-admin-postbox-meta-data">
                                ...
                                <div class="wpfm-admin-menu-selected-item wpfm-admin-postbox-form-field">
                                    <?php $selected_ids = isset($day_data['food_categories']) ? $day_data['food_categories'] : array();
                                    food_manager_dropdown_selection(array(
                                        'multiple' => true,
                                ...
                                <!-- Food Type Selection -->
                                <div class="wpfm-admin-menu-selected-item wpfm-admin-postbox-form-field">
                                    <?php $selected_ids = isset($day_data['food_types']) ? $day_data['food_types'] : array();
                                    food_manager_dropdown_selection(array(
                                        'multiple' => true,
                            ...
                            <!-- Menu Items -->
                            <div class="wpfm-admin-food-menu-items">
                                <?php $item_ids = isset($day_data['food_items']) ? $day_data['food_items'] : array(); ?>
                                ...
                                <span class="no-menu-item-handle-days no-menu-item-handle_<?php echo $day?>" style="display: none;">
                                    <?php _e('Please select the food category or food types to add food items to the menu!', 'wp-food-manager' ); ?>
                                </span>
                                ...
                                <div class="success_message">
                                    <span class="wpfm-success-message-days wpfm-success-message_<?php echo $day?>" style="display: none;">
                                        <?php _e('Foods added to the menu successfully!', 'wp-food-manager' ); ?>
                                    </span>
                                </div>
                            </div>
