...
<div class="wpfm-attributes-wrap wpfm-metabox postbox-<?=$count;?>">
	...
	<div class="wpfm-attribute-type"><p class="wpfm-admin-postbox-form-field">
			<label>Selection type</label>
				...
				<input type="radio" class="radio" name="attribute_type_<?=$attribute;?>[]" value="multiple" <?php echo (isset($attribute_values['type']) && $attribute_values['type'] == 'multiple') ? 'checked="checked"' : '';?>> Multiple</p>
