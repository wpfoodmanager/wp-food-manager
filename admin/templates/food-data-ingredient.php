 ...
 */
?>
<div id="ingredient_food_data_content" class="panel wpfm_panel wpfm-metaboxes-wrapper">
	<div class="wp_food_manager_meta_data">

		<?php do_action('food_manager_food_data_ingredient_start', $thepostid);
		...
		<div class="wpfm-ingredient-fields wpfm-metaboxes">
			<p class="wpfm-ingredient-notice">
				<?php _e('Please drag and drop the available ingredient and enter the value.', 'wp-food-manager'); ?>
			</p>
			<div id="wpfm-ingredient-container" class="wpfm-clear wpfm-lists-container">
				<ul id="wpfm-active-ing-list" class="wpfm-active-list wpfm-sortable-list wpfm-clear ui-sortable" data-title="Active Ingredient">
					...
					<?php if (!empty($food_meta_ingredients)) {
						foreach ($food_meta_ingredients as $ingredients) {
							foreach ($ingredients as $ingredient) {
								...
								if ($ingredient_term_id) { ?>
									...
									<li class='wpfm-sortable-item active-item' data-id='<?php esc_attr_e($ingredient_term_id);?>'>
										<label><?php esc_html_e($ingredient_term_name);?></label>
										<div class='wpfm-sortable-item-values'>
											<input type='number' step='any' class='item-value' name='food_ingredients[<?php esc_attr_e($ingredient_term_id);?>][value]' value='<?php esc_attr_e($ingredient_value);?>'>
											<select name='food_ingredients[<?php esc_attr_e($ingredient_term_id);?>][unit_id]' class='item-unit'>
	...
	<?php do_action('food_manager_food_data_ingredient_end', $thepostid); ?>
	</div>
</div>