					...
					__( 'General', 'wp-food-manager' ),
						array(
							...
							array(
									...
									'desc'       => 'If enabled, the Food Ingredients option will display and manage from the backend.',
									'type'       => 'checkbox',
									'attributes' => array(),
								),
							array(
									...
									'desc'       => 'If enabled, the Food Nutritions option will display and manage from the backend.',
									'type'       => 'checkbox',
									'attributes' => array(),
								),
							array(
									...
									'desc'       => 'If enabled, the Food Units option will display and manage from the backend.',
									'type'       => 'checkbox',
									'attributes' => array(),
								),
							array(
									...
									'desc'       => 'If enabled, the Field editor option will display and manage from the backend.',
									'type'       => 'checkbox',
									'attributes' => array(),
								),
							array(
