...
class WP_Food_Manager_Date_Time {
	...
	**/
	public static function get_default_date_formats(){
		...
		$date_formats['datepicker_date_formats']  = apply_filters('wp_food_manager_datepicker_date_formats',
																		array(
																			'yy-mm-dd',
																			'm-d-yy',
																			'mm-dd-yy',
		...
		$date_formats['view_date_formats'] = apply_filters('wp_food_manager_view_date_formats',
											 	array(
											 		'Y-m-d',
													'n-j-Y',
													'm-d-Y',
