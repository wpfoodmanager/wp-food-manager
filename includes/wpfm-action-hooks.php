...
class WPFM_ActionHooks {
    ...
    /**
     * Add the pending count which food submited from frontend and admin get's pending food count.
     * 
     * @access public
     * @return void
     * @since 1.0.0
    ...
    /**
     * Display notice in formated html.
     * 
     * @access public
     * @return void
     * @since 1.0.0
                ...
                switch ($type) {
                    ...
                    case 'date':
                        if (isset($_POST[$key])) {
                            ...
                            update_post_meta($post_id, '_' . $key, $date_dbformatted);
                        }
                        break;
